...
2. Click on the 'Export to PDF' button on the main report widget.
3. Observe the downloaded file.

## Actual Result
The downloaded file is a 0kb corrupted PDF that cannot be opened. This happens every time for reports with more than 50 rows. The browser console shows a 500 internal server error for the download endpoint.
