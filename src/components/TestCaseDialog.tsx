...
import { Loader2, AlertCircle, CheckCircle, Wand2, FileSpreadsheet } from 'lucide-react';
    ...
    <Dialog open={isOpen} onOpenChange={(open) => !open && handleDialogClose()}>
      <DialogContent className="max-w-4xl h-[90vh] flex flex-col p-0">
        <DialogHeader className="p-6 pb-4 border-b">
          ...
          <DialogDescription>
            Review the test cases generated by AI for &quot;{issue?.summary}&quot;. You can then attach them to Jira as an Excel file.
          </DialogDescription>
        </DialogHeader>
